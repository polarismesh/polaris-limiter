...
func (c *rateLimitGRPCV2Client) Service(ctx context.Context, opts ...grpc.CallOption) (RateLimitGRPCV2_ServiceClient, error) {
	stream, err := c.cc.NewStream(ctx, &_RateLimitGRPCV2_serviceDesc.Streams[0], "/polaris.limiter.v2.RateLimitGRPCV2/Service", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *rateLimitGRPCV2Client) TimeAdjust(ctx context.Context, in *TimeAdjustRequest, opts ...grpc.CallOption) (*TimeAdjustResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/polaris.limiter.v2.RateLimitGRPCV2/TimeAdjust", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RateLimitGRPCV2_TimeAdjust_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/polaris.limiter.v2.RateLimitGRPCV2/TimeAdjust",
	}
...
var _RateLimitGRPCV2_serviceDesc = grpc.ServiceDesc{
	ServiceName: "polaris.limiter.v2.RateLimitGRPCV2",
...
func init() {
	proto.RegisterFile("grpcapi_ratelimit_v2.proto", fileDescriptor_grpcapi_ratelimit_v2_8624c10adb22d2a6)
}

var fileDescriptor_grpcapi_ratelimit_v2_8624c10adb22d2a6 = []byte{
	...
	,
}
